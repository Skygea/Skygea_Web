...
export default function Footer() {
  return (
    <div className="px-6 sm:px-10 md:px-20 lg:px-32 xl:px-40 2xl:px-50 py-10 text-white">
      <div className="flex flex-col gap-10 lg:gap-20 lg:flex-row flex-wrap justify-between">
        {/* Brand Info */}
        <div className="flex flex-col max-w-md">
          <p className="text-3xl font-bold">Skygea.</p>
        ...
        <div>
          ...
          <ul className="mt-5 flex flex-col gap-2 text-sm text-[#CCCACA]">
            <li>
              <Link href="/privacy-policy" className="cursor-pointer no-underline">
                Privacy Policy
              </Link>
            </li>
            <li>
